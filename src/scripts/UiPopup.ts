...
export class UiPopups extends Phaser.GameObjects.Container {
    ...
    menuBtnInit() {
        ...
        this.menuBtn.setPosition( gameConfig.scale.width * 0.17, gameConfig.scale.height * 0.08 );
    ...
    exitButton(){
        ...
        this.exitBtn.setPosition(gameConfig.scale.width / 1.28 , gameConfig.scale.height * 0.085);
    ...
    openSettingPopup() {
        ...
        this.settingClose.setPosition(550, -250).setScale(0.8);
